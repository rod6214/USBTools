...
//    Interface 1
   ...
   {/*Enpoint 1 IN descriptor*/
       ...
       0x03, // bmAttributes
       USB_BUFFER_LEN, // MaxPacketSize (LITLE ENDIAN)
       1, // bInterval
   },
...
const struct {BYTE report[HID_RPT01_SIZE];}hid_rpt01={
{
    ...
    0x29, USB_BUFFER_LEN,   //      Usage Maximum 	//64 input usages total (0x01 to 0x40)
    0x15, 0x00,             //      Logical Minimum (data bytes in the report may have minimum value = 0x00)
    0x26, 0xFF, 0x00,      	//      Logical Maximum (data bytes in the report may have maximum value = 0x00FF = unsigned 255)
    0x75, 0x08,             //      Report Size: 8-bit field size
    0x95, USB_BUFFER_LEN,   //      Report Count: Make sixty-four 8-bit fields (the next time the parser hits an "Input", "Output", or "Feature" item)
    ...
    0x19, 0x01,             //      Usage Minimum 
    0x29, USB_BUFFER_LEN,   //      Usage Maximum 	//64 output usages total (0x01 to 0x40)
