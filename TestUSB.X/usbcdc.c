...
typedef far unsigned char* codePtr;
...
const far unsigned char device_descriptor[] = { //
...
const far unsigned char device_qualifier_descriptor[] = { //
...
const far char const_values_0x00_0x00[] = { 0, 0 };
const far char const_values_0x00_0x01[] = { 0, 1 };
const far char const_values_0x01_0x00[] = { 1, 0 };
const far char const_values_status[] = { (USBCDC_SELF_POWERED<<0), 0 }; // first byte tells self powered and remote wakeup status

config_struct config_descriptor = {
    {
...
const far unsigned char string_descriptor0[] = { // available languages  descriptor
    0x04, STRING_DESCRIPTOR, //
    0x09, 0x04, //
};

const far unsigned char string_descriptor1[] = { //
...
const far unsigned char string_descriptor2[] = { //
...
static volatile unsigned char cdcint_buffer[USBCDC_BUFFER_LEN];
const far char cdc_line_coding[7] = {(9600&0xFF),(9600>>8),0,0,0,0,8};
...
char usbcdc_wr_busy() {
	return (((char)ep2_i.STAT & (char)UOWN)!=(char)0);
}
