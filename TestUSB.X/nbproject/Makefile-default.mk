...
SOURCEFILES_QUOTED_IF_SPACED=configuration_bits.c cstream.c kernel.c logger.c main.c messageTable.c pic-config.c printft.c usb.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/cstream.p1 ${OBJECTDIR}/kernel.p1 ${OBJECTDIR}/logger.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/messageTable.p1 ${OBJECTDIR}/pic-config.p1 ${OBJECTDIR}/printft.p1 ${OBJECTDIR}/usb.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/configuration_bits.p1.d ${OBJECTDIR}/cstream.p1.d ${OBJECTDIR}/kernel.p1.d ${OBJECTDIR}/logger.p1.d ${OBJECTDIR}/main.p1.d ${OBJECTDIR}/messageTable.p1.d ${OBJECTDIR}/pic-config.p1.d ${OBJECTDIR}/printft.p1.d ${OBJECTDIR}/usb.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/configuration_bits.p1 ${OBJECTDIR}/cstream.p1 ${OBJECTDIR}/kernel.p1 ${OBJECTDIR}/logger.p1 ${OBJECTDIR}/main.p1 ${OBJECTDIR}/messageTable.p1 ${OBJECTDIR}/pic-config.p1 ${OBJECTDIR}/printft.p1 ${OBJECTDIR}/usb.p1

# Source Files
SOURCEFILES=configuration_bits.c cstream.c kernel.c logger.c main.c messageTable.c pic-config.c printft.c usb.c
...
${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.map  -D__DEBUG=1  -mdebugger=none  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto        $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} ${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.hex 
	
else
${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} ${DISTDIR} 
	${MP_CC} $(MP_EXTRA_LD_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -Wl,-Map=${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.map  -DXPRJ_default=$(CND_CONF)  -Wl,--defsym=__MPLAB_BUILD=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     $(COMPARISON_BUILD) -Wl,--memorysummary,${DISTDIR}/memoryfile.xml -o ${DISTDIR}/TestUSB.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
