...
#define USB_BUFFER_INTERRUPT_LEN 32
...
#define USB_TX1_REG (USB_RX0_REG + USB_BUFFER_INTERRUPT_LEN)
#define USB_RX1_REG (USB_TX1_REG + USB_BUFFER_INTERRUPT_LEN)
#define USB_TX2_REG (USB_RX1_REG + USB_BUFFER_INTERRUPT_LEN)
#define USB_RX2_REG (USB_TX2_REG + USB_BUFFER_INTERRUPT_LEN)
